...
import com.xhkj.common.utils.ObjectUtil;
...
public class ControllerLogAspect {
    ...
    private Logger log= LogManager.getLogger(ControllerLogAspect.class.getName());
    ...
    @Pointcut("@annotation(com.xhkj.common.annotation.SystemControllerLog)")
    ...
    public void after(JoinPoint joinPoint){
        try {
            ...
            if (null != username) {
                ...
                //日志标题
                dbLog.setName(getControllerMethodDescription(joinPoint));
                //日志类型
                dbLog.setType(1);
                //日志请求url
                dbLog.setUrl(request.getRequestURI());
                //请求方式
                dbLog.setRequestType(request.getMethod());
                //请求参数
                Map<String,String[]> logParams = request.getParameterMap();
                dbLog.setMapToParams(logParams);
                IPInfoUtil.getInfo(request, ObjectUtil.mapToStringAll(logParams));
                //请求用户
                dbLog.setUser(username);
                //请求IP
                dbLog.setIp(IPInfoUtil.getIpAddr(request));
                //IP地址
                dbLog.setIpInfo(IPInfoUtil.getIpCity(IPInfoUtil.getIpAddr(request)));
                //请求开始时间
